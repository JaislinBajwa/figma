  ...
  return (
    <div className='card'>
        ...
        <div className='eventList'>
            <BrowserEventList title={"Network"} value={"2"} />
            <BrowserEventList title={"CPU Utilization"} value={"30"} />
            <BrowserEventList title={"DB connections"} value={"21"} />
            <BrowserEventList title={"Read latency"} value={"5.22ms"} />
            <BrowserEventList title={"Write latency"} value={"6.4ms"} />
            <BrowserEventList title={"Read throughput"} value={"4"} />

...
function Browser() {
  return (
    <div className='card'>
        <h2>ECS-Fargate-Infra</h2>
        <div className='eventBox'>
            <div className='error'><BrowserEvent title={"Error Box"} value={"8"} /></div>
        ...
        <div className='eventList'>
            ...
            <BrowserEventList title={"Memory Utlilization"}value={"98%"} />
            <BrowserEventList title={"Task Exited"} value={"2"} />
            <BrowserEventList title={"Tasks Running"} value={"5"}/>
        </div>
